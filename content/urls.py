...
urlpatterns=[
  ...
  path('home/detail/month_search/',views.each_month_study_time_search,name="detail_month_search"),
  path('home/detail/week/',views.each_week_study_time,name="detail_week"),
  path('home/detail/week_search/',views.each_week_study_time_search,name="detail_week_search"),
  path('home/detail/day/',views.day_study_time,name="detail_day"),
  path('home/detail/dat_search',views.day_study_time_search,name="detail_day_search"),
  path('logout/',views.Logout,name='logout'),
  path('timer/',views.timer,name='timer'),
  path('studylog/',views.studytime,name='studylog'),
  path('studylog/edit/',views.edit_studylog,name='edit_studylog'),
  path('studylog/edit/search/',views.after_search_edit_studylog,name="search_edit_studylog"),
